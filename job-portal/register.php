...
<head>
    ...
    <style>
        body { background: linear-gradient(135deg, var(--primary) 0%, var(--primary-darker) 100%); min-height: 100vh; }
        .register-card { border-radius: 20px; box-shadow: 0 25px 50px rgba(15, 23, 42, 0.35); overflow: hidden; }
        .card-header { background: linear-gradient(135deg, var(--accent) 0%, var(--accent-dark) 100%); color: white; padding: 2rem; text-align: center; }
