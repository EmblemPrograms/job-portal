...
<div class="container my-5">
        ...
        <div class="justify-content-center">
            ...
            <div class="col-lg-12 mb-4">
                <div class="card job-card">
                    <?php $cat = job_category($job['title']); ?>
                    <div class="job-header text-white d-flex align-items-center">
                        <div class="detail-logo mr-4"><?php echo htmlspecialchars(company_initials($job['company'])); ?></div>
                        <div>
                            <span class="badge badge-light text-dark mb-2"><i class="fas <?php echo $cat['icon']; ?> mr-1"></i> <?php echo htmlspecialchars($cat['name']); ?></span>
                            <h1 class="display-5 font-weight-bold mb-1"><?php echo htmlspecialchars($job['title']); ?></h1>
                            <h4 class="mb-0 font-weight-normal"><i class="fas fa-building mr-1"></i> <?php echo htmlspecialchars($job['company']); ?></h4>
                        </div>
                    </div>
    ...
    <a href="apply.php?job_id=<?php echo (int)$job['id']; ?>" 
