                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col-auto">
                                <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">
                                    <?php
                                    $result = $conn->query("SELECT COUNT(*) as cnt FROM applications WHERE status = 'pending' OR status IS NULL");
                                    echo $result->fetch_assoc()['cnt'] ?? 0;
                                    ?>
                                </div>
                            </div>
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                            <?php
                            $result = $conn->query("SELECT COUNT(*) as cnt FROM applications WHERE status = 'approved'");
                            echo $result->fetch_assoc()['cnt'] ?? 0;
                            ?>
                        </div>
                    </div>
